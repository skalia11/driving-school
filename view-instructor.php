...
$sqlget= mysqli_query($dbhandle,"SELECT first_name,address,city,postal,last_name,dl_number,phone_num,date_birth,gender FROM PEOPLE  join instructor on instructor.sincard=people.sincard where people.sincard ='$sin'");
...
echo "<tr><td><h2><font color='red'>Company Role:</h2></td><td><h3> Instructor</h3></td></tr>"; 

			...
			<div class="shortcutHome">
				<?php 
					if(isset($_POST['submit']))
					{
						...
						edit_instructor($sincard,$date_birth,$address,$city, $postal, $phone_num,$last_name,$first_name,$gender,$dl_number);
					}
				?>
...
$sqls= mysqli_query($dbhandle,"SELECT people.sincard, people.address,people.city,people.postal, people.first_name,people.last_name,instructor.dl_number,people.phone_num,people.date_birth,people.gender FROM PEOPLE  join instructor on instructor.sincard=people.sincard WHERE instructor.sincard='$sin'");
			...
			<table width="95%">
				<form name="newinstructor" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">	
					...
					<tr>
							...
							<input type="text" autocomplete="off" name="sincard" class="pendek" hidden>
					...
					<tr>
						...
						<td>
							<input type="text" autocomplete="off" name="dl_number" value="<?php echo $sqlf['dl_number']; ?>" class="pendek" required>
						</td>
					</tr>
					<tr>
						<td width="125px">
